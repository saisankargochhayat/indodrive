...
FRONT_MOTOR_ENABLE_PIN = configuration.FRONT_MOTOR_ENABLE_PIN
...
def set_gpio_pins():
    ...
    GPIO.setup(FRONT_MOTOR_ENABLE_PIN, GPIO.OUT)

def get_pwm_imstance_back():
    """Returns a PWM instance"""
    return GPIO.PWM(BACK_MOTOR_ENABLE_PIN, PWM_FREQUENCY)

def get_pwm_imstance_front():
    """Returns a PWM instance"""
